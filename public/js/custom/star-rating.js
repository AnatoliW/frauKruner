...
(function (factory) {
    ...
    $.fn.rating.defaults.filledStar = '<i class="fa fa-star"></i>';
    $.fn.rating.defaults.emptyStar = '<i class="fa fa-star-o"></i>';
    $.fn.rating.defaults.clearButton = '<i class="glyphicon glyphicon-minus-sign"></i>';
    $.fn.rating.defaults.language = 'de';
    ...
    $.fn.ratingLocales.de = {
        ...
        clearCaption: 'Noch keine Erfahrung geteilt'
    };
    ...
    $(document).ready(function () {
        var $input = $('input.rating').not('.product_rating, .published_rating');
        if ($input.length) {
