<x-dashboard type='seller' title="Meine Nachrichten" :bread="[
    'Startseite' => route('home'),
    'Profil' => route('seller.dashboard'),
    'Meine Nachrichten' => route('seller.news'),
]">
            ...
            <div class="card-item-messages__main-info">
                ...
                <div class="col-prod-text pt-3">
                    ...
                    @if($notification->title )
                        ...
                        @else
                        <p {{$notification->product ? $notification->product->name  :'' }}</p>
                        @endif
                    </div>
                ...
                <div class="col-prod-price">
                    @if(!$notification->title)
                      <a href="{{route('seller.sales')}}" class="btn btn-secondary">zu den Verkäufen</a>
                    @endif
