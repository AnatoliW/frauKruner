<x-filament-panels::page>
    ...
    <style>
        ...
        .boost-product-name-inline {
            font-weight: 700;
            color: rgb(var(--gray-800));
        }

        .dark .boost-product-name-inline {
            ...
            <x-filament::section>
                            ...
                            <label class="boost-card {{ $active ? 'active' : '' }}">
                                <div>
                                    ...
                                    <p class="boost-package-desc">
                                        Für {{ $package->days }} Tage sichtbar hervorheben.
                                    </p>
                                </div>
                ...
                <div class="boost-footer">
                    ...
                    <x-filament::button
                        ...
                        wire:target="pushProduct"
                    >
                        <span wire:loading.remove wire:target="pushProduct">
                            Push starten
                        </span>

                        <span wire:loading wire:target="pushProduct">
                            Wird verarbeitet...
                        </span>
                    </x-filament::button>
                </div>
