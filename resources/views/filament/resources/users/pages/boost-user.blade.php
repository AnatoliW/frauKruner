    ...
    <form wire:submit="pushUser">
        <div class="boost-wrap">
            <div class="boost-header">
                <div class="boost-eyebrow">Profil Pushen</div>
                <h2 class="boost-heading">Waehle ein Paket fuer {{ $user->username ?? $user->name ?? 'dieses Profil' }}</h2>
            ...
            <div class="boost-grid">
                @foreach ($packages as $package)
                    ...
                    <label class="boost-card {{ $active ? 'active' : '' }}">
                        ...
                        <p class="boost-title">{{ $priceFormat($package->price_with_tax) }}</p>
                    </label>
                @endforeach
            </div>
            ...
            <div class="boost-actions">
                ...
                <span class="boost-note">Alle Preise inkl. MwSt. Nach dem Push wirst du direkt zur Zahlungsseite weitergeleitet.</span>
            </div>
        </div>
    </form>
</x-filament-panels::page>
